...
public partial class AppShell : Shell
{
    public AppShell()
    {
        ...
        Routing.RegisterRoute(nameof(ConfirmDeliveryView), typeof(ConfirmDeliveryView));
        ...
        Routing.RegisterRoute(nameof(CartManagerView), typeof(CartManagerView));
        ...
        Routing.RegisterRoute(nameof(CreateTaxView), typeof(CreateTaxView));
