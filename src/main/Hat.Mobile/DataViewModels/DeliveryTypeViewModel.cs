...
namespace Hat.DataViewModels
{
    public class DeliveryViewModel : BaseViewModel
    {
        ...
        public DeliveryViewModel(ObservableCollection<ProductListViewModel> products,  IMediator mediator)
        {
        ...
        {
            await Microsoft.Maui.Controls.Application.Current.MainPage.Navigation.PushAsync(new ConfirmAddressView(new ConfirmAddressViewModel(Products, deliveryType,_mediator)));
        }
